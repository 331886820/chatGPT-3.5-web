...
export function Settings(props: { closeSettings: () => void }) {
  ...
  const myImage = require('../../public/images/pay.png').default;
    ...
    <ErrorBoundary>
      ...
      <div className={styles["settings"]}>
        <List>
		 ...
		 <SettingItem title='联系邮箱'>
		   <div className={styles["window-header-main-email"]}>
		     331886820@163.com
		   </div>
		 </SettingItem>   
		  
		 <SettingItem title='打赏一杯咖啡'>
		  <div className={styles["window-header-main-newtext"]}>
			<img className={styles["settings-pay-img"]} src={myImage.src} alt="请我喝咖啡" />
		  </div>
		</SettingItem>
